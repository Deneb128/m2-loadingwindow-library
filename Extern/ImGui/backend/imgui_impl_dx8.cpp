...
struct ImGui_ImplDX8_Data
{
    ...
    ImGui_ImplDX8_Data()        { memset(this, 0, sizeof(*this)); VertexBufferSize = 5000; IndexBufferSize = 10000; }
};
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                //bd->pd3dDevice->SetTextureStageState(0, D3DTSS_COLORARG1, D3DTA_TEXTURE);
                //bd->pd3dDevice->SetTextureStageState(0, D3DTSS_COLORARG2, D3DTA_DIFFUSE);
                //bd->pd3dDevice->SetTextureStageState(0, D3DTSS_ALPHAOP, D3DTOP_DISABLE);
                //bd->pd3dDevice->SetScissorRect(&r);
                
                // d3d9
                //STDMETHOD(DrawIndexedPrimitive)(THIS_ D3DPRIMITIVETYPE,
                //    INT BaseVertexIndex,
                //    UINT MinVertexIndex,
                //    UINT NumVertices,
                //    UINT startIndex,
                ...
                bd->pd3dDevice->DrawIndexedPrimitive(D3DPT_TRIANGLELIST,
                    0U, (UINT)cmd_list->VtxBuffer.Size,
                    pcmd->IdxOffset + global_idx_offset,
                    pcmd->ElemCount / 3
                );
                // bd->pd3dDevice->DrawIndexedPrimitive(D3DPT_TRIANGLELIST,
                // pcmd->VtxOffset + global_vtx_offset, //
                // 0, (UINT)cmd_list->VtxBuffer.Size,
                // pcmd->IdxOffset + global_idx_offset,
                // pcmd->ElemCount / 3
                // );
                //
